...
public class ResponseCodeConst {
    ...
    static {
        ...
        ResponseCodeContainer.register(UserResponseCodeConst.class, 3001, 3999);
        ResponseCodeContainer.register(FileResponseCodeConst.class, 4001, 4999);
        ResponseCodeContainer.register(SysParamResponseCodeConst.class, 5001, 5999);
        ResponseCodeContainer.register(RoleResponseCodeConst.class, 6001, 6999);
        ResponseCodeContainer.register(ResourceResponseCodeConst.class, 7001, 7999);
