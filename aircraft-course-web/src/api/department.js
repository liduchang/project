...
export const departmentApi = {
  ...
  getDepartmentUserList: () => {
    return getAxios('/department/listUser');
  },
  // 添加部门
  addDepartment: (data) => {
  ...
  // 根据部门名称获取员工列表
  getListUserByDepartmentName: (departmentName) => {
    return getAxios('/department/listUserByDepartmentName?departmentName=' + departmentName);
  },
  // 上下移动
