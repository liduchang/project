...
<script>
import { systemParamApi } from '@/api/system-param';
export default {
  name: 'SystemConfig',
  components: {},
  props: {},
  ...
  methods: {
    ...
    async getSystemConfigList () {
      ...
      let result = await systemParamApi.getSystemConfigList({
        ...searchForm,
    ...
    async updateSystemConfig () {
      this.$Spin.show();
      let result = await systemParamApi.updateSystemConfig(this.updateItem);
      this.$Spin.hide();
    ...
    async addSystemConfig () {
      try {
        ...
        let result = await systemParamApi.addSystemConfig(this.saveItem);
